			...
			if(btnval.equalsIgnoreCase("update"))
		        ...
		        String t9 = request.getParameter("t9");
					try
					{
						Class.forName("oracle.jdbc.driver.OracleDriver");
						Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hotel", "hotel");
						PreparedStatement psmt=conn.prepareStatement("update customer set customer_name=?,address=?,mob_no=?,dob=?,gender=?,marital_status=?,created_date=?,created_by=? where customer_id=?");
						psmt.setString(1,t2);
						psmt.setString(2,t3);
						psmt.setString(3,t4);
						psmt.setString(4,t5);
					 ...
					 try
					  {
						  ...
						  ResultSet rs=smt.executeQuery("select * from customer"); // rs is the buffer
						  %>
						  <center>
						  <table border=2>
						  <tr>
					 ...
					 try
					  {
						  ...
						  Statement smt=conn.createStatement();
						  ResultSet rs=smt.executeQuery("select * from customer where customer_id='"+t1+"'"); // rs is the buffer
						  %>
						  <center>
						  <table border=2>
						  <tr>
					...
					try
					  {
						  ...
						  if(col.equalsIgnoreCase("all"))
							  ...
							  rs=smt.executeQuery("select * from customer where "+col+ "=" +"'"+t1+"'");
						%>
						  <center>
						  <table border=2>
						  <tr>
